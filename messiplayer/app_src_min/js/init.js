  ...
  'app_src_min/images/subtitles-preview-bg.png" class="subtitle-settings-preview-bg" />\n\
      ...
      >\n\
        ...
        <div id="playlists-instructions">\n\
          MessiTV is a general media player and it does not include any content, MessiTV is not responsible for the content you use in the app.<br/> Please follow <span class="highlight website-url"></span> to add or manage playlists\n\
        </div>\n\
