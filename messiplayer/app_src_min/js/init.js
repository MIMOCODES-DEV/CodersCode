...
// invoked from login_page.getPlayListDetail() (login_operation.js) on cold start / refresh.
...
var HTML =
  ...
  'app_src_min/images/logo.png" />\n\
      ...
      <div id="loading-issue-container">\n\
        ...
        <div id="no-playlist-issue-container" class="loading-issue-item hide">\n\
          <div class="loading-issue-message-container">\n\
            <div class="loading-issue-text">\n\
              You havenâ€™t uploaded your playlist yet. Our app doesnâ€™t supply any\n\
    ...
    <div id="terms-modal" class="hide">\n\
      <div class="terms-modal-panel">\n\
        <div class="terms-modal-title">Welcome to MessiTV</div>\n\
  ...
  'app_src_min/images/logo.png" alt="Logo" />\n\
      ...
      <div id="settings-page">\n\
        <div class="settings-page-left-part">\n\
          ...
          <div class="settings-page-option" onclick="settings_page.handleMenuClick()" onmouseenter="settings_page.hoverSettingsItem(12)" data-word_code="app_initialization">App Initialization</div>\n\
          </div>\n\
  ...
  'app_src_min/images/subtitles-preview-bg.png" class="subtitle-settings-preview-bg" />\n\
      ...
      <div id="stararcs-page" style="display: none;">\n\
        ...
        <div class="stararcs-body">\n\
          <div id="stararcs-proxy-loading" class="stararcs-loader" style="display:none;"><div class="qr-loader"></div></div>\n\
          <div id="stararcs-proxy-not-active" class="stararcs-not-active">\n\
            ...
            <div class="stararcs-btn" id="stararcs-proxy-sub-confirmation-btn" data-word_code="continue" onmouseenter="stararcs_page.hoverSmartProxyOption(0)" onclick="stararcs_page.clickSmartProxyOption(0)">Continue</div>\n\
          </div>\n\
          <div id="stararcs-proxy-active" class="stararcs-active">\n\
            <div id="stararcs-proxy-guest-info" class="stararcs-info-card" style="display:none;">\n\
              ...
              <div class="stararcs-quota">\n\
                <div class="stararcs-quota-text" id="stararcs-proxy-quota-text">10 GB remaining of 10 GB</div>\n\
                <div class="stararcs-quota-bar"><div class="stararcs-quota-bar-fill" id="stararcs-proxy-quota-bar-fill"></div></div>\n\
              </div>\n\
            </div>\n\
            <div class="stararcs-item stararcs-toggle-row" onmouseenter="stararcs_page.hoverSmartProxyOption(0)" onclick="stararcs_page.handleMenuClick()">\n\
              ...
              <div class="stararcs-toggle off"><div class="stararcs-toggle-circle"></div></div>\n\
            </div>\n\
            <div class="stararcs-item stararcs-value-row" onmouseenter="stararcs_page.hoverSmartProxyOption(1)" onclick="stararcs_page.handleMenuClick()">\n\
              ...
              <div class="stararcs-value-container">\n\
                <svg class="stararcs-arrow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path d="M14.2893 5.70708C13.8988 5.31655 13.2657 5.31655 12.8751 5.70708L7.98768 10.5993C7.20729 11.3805 7.2076 12.6463 7.98837 13.427L12.8787 18.3174C13.2693 18.7079 13.9024 18.7079 14.293 18.3174C14.6835 17.9269 14.6835 17.2937 14.293 16.9032L10.1073 12.7175C9.71678 12.327 9.71678 11.6939 10.1073 11.3033L14.2893 7.12129C14.6799 6.73077 14.6799 6.0976 14.2893 5.70708Z" fill="#ffffff"></path> </g></svg>\n\
            ...
            <div id="stararcs-proxy-guest-subscribe" class="stararcs-subscribe" style="display:none;">\n\
              ...
              <div id="stararcs-proxy-guest-sub-qr-container" class="stararcs-qr-card"></div>\n\
            </div>\n\
          </div>\n\
        </div>\n\
      </div>\n\
      ...
      >\n\
        ...
        <div class="playlists-page-btns-container">\n\
          <div class="playlists-page-btn playlist-page-auto-switch-btn" onmouseenter="playlist_page.hoverBottomMenu(0)" onclick="playlist_page.handleMenuClick()" style="display:flex;align-items:center;justify-content:space-between;gap:1.5rem;padding:0.7rem 2rem;">\n\
            <span data-word_code="auto_switch_playlist">Auto Switch Playlist</span>\n\
            <div class="settings-toggle-switch-value playlist-page-auto-switch-toggle-value off" style="flex-shrink:0;"><div class="settings-toggle-switch-circle"></div></div>\n\
          </div>\n\
          <div class="playlists-page-btn" onmouseenter="playlist_page.hoverBottomMenu(1)" onclick="playlist_page.handleMenuClick()"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 189 151" fill="none"><g clip-path="url(#clip0_21_5034)"><path d="M24.3601 94.7C0.330059 91.86 -9.24994 59.73 11.0401 44.32C19.6401 37.79 25.6001 39.12 35.3101 39.14C53.3401 39.17 71.3801 39.05 89.4101 39.12L114.99 0.72L116.66 0L188.73 150.98H142.75C141.41 147.72 140.08 144.29 138.54 141.13C127.11 117.8 115.71 91.8 103.32 69.29C95.9501 55.91 81.0401 54.11 71.5001 66.35L52.8501 94.71H82.7001C95.3701 94.71 108.83 109.24 109.17 121.81C109.51 134.31 98.0101 150.98 84.7601 150.98H13.0401L50.7901 94.71C42.4301 93.99 32.5401 95.68 24.3701 94.71L24.3601 94.7Z" fill="white"/></g><defs><clipPath id="clip0_21_5034"><rect width="188.73" height="150.98" fill="white"/></clipPath></defs></svg> StarArcs</div>\n\
        ...
        <div class="playlists-page-footer">MessiTV is a general media player and it does not include any content, MessiTV is not responsible for the content you use in the application.<br />Please follow <span class="website-url highlight"></span> to add or manage your playlists.</div>\n\
  ...
  'app_src_min/images/imdb-logo.png" alt="imdb" class="rating-provider-logo">\n\
                ...
                <div class="movie-synopsis">\n\
                  <div id="movie-synopsis">Sonne, Wasser, Surfen - fÃ¼r die meisten Kinder ist das Ferienheim am Wolfgangsee ein Paradies - doch die zehnjÃ¤hrige Lotte aus Frankfurt mÃ¶chte lieber allein sein, Klavier spielen und das Mozarthaus besichtigen. Und dann begegnet ihr auch noch Luise, und die sieht ihr verdammt Ã¤hnlich. Luise ist mit ihrem Musikervater durch ganz Afrika getourt, schlÃ¤gt PurzelbÃ¤ume und erzÃ¤hlt angeberische Geschichten von Krokodilen, Geiern und Flamingos. Lotte und Luise kÃ¶nnen sich zunÃ¤chst nicht riechen, aber bald treten sie im Schullandheim als Doppeltes Lottchen auf: Sie haben die sensationelle Entdeckung gemacht, dass sie Zwillinge sind.</div>\n\
                </div>\n\
                <div class="movie-details">\n\
