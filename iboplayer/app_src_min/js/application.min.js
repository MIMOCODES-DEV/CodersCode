...
i.hide(),e.preventDefault()}}})}},WEBSITE_URL="https://iboplayer.com";
...
function n(e,t){return parseInt($(e).css(t).replace("px",""))}o=o||!1;var l=$(t).position(),i,c,d,h,c,i,h;return"vertical"===i?(i=n(e,"height"),c=n(t,"height"),d=0,!s||a?(
// Adjust scroll if element is below viewport
l.top+c>=i&&(d=l.top+c-i),
// Adjust scroll if element is above viewport
l.top<0&&(d=l.top),$(e).animate({scrollTop:"+="+d},10,"swing")):(h=l.top+c/2-i/2,$(e).animate({scrollTop:"+="+h},100,"linear")),d):(c=n(e,"width"),i=n(t,"width"),h=0,!s||a?(
...
i.unshift(o.newlyAdded),i.unshift(o.topRated),i.unshift(o.favourite),i.unshift(o.recent),i.unshift(r),
...
var b=a[f].category_id.toString();a[f].movies=void 0===v[b]?[]:v[b]}l.movies=m,c.movies=p,a.unshift(c),a.unshift(l),a.unshift(n);
...
// Add undefined category to the list
i.push(o.undefined),this.movie_key),n=y(),l=(this.favourite_ids=n,b()),c=(this.saved_video_times=l,k(l)),l=[],_=[],u=[],m=[],p=[],g={},v=Math.floor(Date.now()/1e3),f=0;f<e.length;f++)w(e[f],g,c,n,m,_,u,p,v);
// Order recent series based on watch progress
// Clear the series list
// Helper functions
function y(){var e=storage_id+settings.playlist.id+t+"_favourite",e=JSON.parse(localStorage.getItem(e));return e||[]}function b(){var e=storage_id+settings.playlist.id+"_saved_"+t+"_times",e=localStorage.getItem(e);return e?JSON.parse(e):[]}function k(e){return"xc"===settings.playlist.playlist_type?e.map(function(e){return parseInt(e.stream_id,10)}):e.map(function(e){return e.stream_id})}function w(e,t,i,s,a,o,r,n,l){void 0!==e.category_id&&"null"!=e.category_id&&null!=e.category_id||(e.category_id="undefined");var c=e.category_id.toString();t[c]||(t[c]=[]),t[c].push(e),e.is_recent=!1,-1!==i.indexOf(e[h])&&a.push(e),-1!==s.indexOf(e[h])&&("before"===d.favourite_insert_position?o.unshift(e):o.push(e)),e.rating&&!isNaN(parseFloat(e.rating))&&n.push(e),
...
// Add special categories at the beginning
i.unshift(o.recentlyModified),i.unshift(o.topRated),i.unshift(o.favourite),i.unshift(o.recent),i.unshift(r),
// Remove undefined category if empty
...
b[o]&&(s="has-progress",o=b[o],o.duration)&&"vod"==k&&(a=100*parseFloat(o.time)/parseFloat(o.duration)+"%"),r=localStorage.getItem(storage_id+settings.playlist.id+"_saved_series_times"))
...
s.showTrailerTimeout=setTimeout(function(){s.runMovieTrailer(s.movies[s.keys.menu_selection])},5e3)},1e3),this.hiddenAndShowSidebar()},fetchHoverMovie:function(e){var t=this,i,s,e,e,a,e,o,e,r,n;
...
s=e.series_id?(i="series",e.series_id):(i="vod",e.stream_id),this.isTMDBAllowed)&&(e=this.getCachedMovieInfo(i,s),e?(e=e.info,e&&0!==e.length||(t.fetchHoverMovie(),$("#movie-image").attr("src",HOST+"app_src_min/images/default_movie_bg.png")),this.updateMovieUI(e),r=e.tmdb_id||e.tmdb,e.backdrop_path&&0<e.backdrop_path.length&&(n=e.backdrop_path[0]),this.fetchMovieImages(r,n||HOST+"app_src_min/images/default_movie_bg.png"),$("#movie-image").fadeIn()):
...
switch(this.searching_for){case"replay":case"live":o=0;break;case"vod":o=1;break;case"series":o=2}"live"==this.searching_for||"replay"==this.searching_for?t.hor_keys[o]+=6*e:t.hor_keys[o]+=8*e;var r=this.filtered_movies[o];
// If navigating upward (increment < 0) and:
// - Already at the top row or no valid row is found (ver_selection === -1)
(t.hor_keys[o]>=r.length&&(t.hor_keys[o]=r.length-1),t.hor_keys[o]<0)?(t.hor_keys[o]=0,this.hoverTopMenu(0)):(
// If a valid row is found
-1!==o&&
// Update the hover to the new row and horizontal position
...
turn_off_page.prev_route="home-page","turn-off-page"!==current_route&&(current_route="home-page"),$("#loading-page").addClass("hide"),$("#login-container").hide(),$("#app").show(),$("#home-page").removeClass("hide");var i="";languages&&languages.map(function(e,t){i+='        <div           class="setting-select-option"          data-word_code="'+e.code+'"          data-language="'+e.code+'"          onmouseenter="settings_page.hoverChangeLanguageOption('+t+', true)"          onclick="settings_page.handleMenuClick()"        >          '+e.name+"        </div>"}),$("#settings-languages-options").html(i),settings_page.change_language_items=$("#change-language-settings .setting-select-option"),settings_page.doms_translated=$("*").filter(function(){return void 0!==$(this).data("word_code")}),settings_page.changeDomsLanguage(),this.applyChannelTheme(),this.checkForPlaylistExpirationDate(),this.setUserInfoTimer()},reEnter:function(){$("#home-page").removeClass("hide"),current_route="home-page"},requestMovies:function(t,e){showLoader(!0),this.isLoading=!0,this.manuallyAborted=!1;var i=this,s=api_host_url+"/player_api.php?username="+user_name+"&password="+password+"&action=",a,o;switch(t){case"live":o="get_live_categories",a="get_live_streams";break;case"vod":o="get_vod_categories",a="get_vod_streams";break;case"series":o="get_series_categories",a="get_series"}var r=function(e){switch(t){case"live":LiveModel.setMovies(e);break;case"vod":VodModel.setMovies(e);break;case"series":SeriesModel.setMovies(e)}},n=function(e){switch(t){case"live":LiveModel.setCategories(e);break;case"vod":VodModel.setCategories(e);break;case"series":SeriesModel.setCategories(e)}},l=api({method:"get",url:s+o,success:function(e){n(e)}}),s=api({method:"get",url:s+a,success:function(e){r(e)}});i.activeRequests=[l,s],$.when(l,s).then(function(){try{switch(t){case"live":LiveModel.insertMoviesToCategories();break;case"vod":VodModel.insertMoviesToCategories();break;case"series":SeriesModel.insertMoviesToCategories()}}catch(e){showToast("Error","Data loading failed")}}).then(function(){showLoader(!1),i.initPage(t,e)}).fail(function(){showLoader(!1),i.isLoading=!1,i.manuallyAborted?showToast("Cancelled","Data loading aborted"):(i.isLoading=!1,showToast("Failed","Data loading failed"))})},initPage:function(e,t){switch(e){case"live":this.dataLoaded.live=!0,checkActivePlaylist()&&channel_page.init("home-page",null,t);break;case"vod":this.dataLoaded.vod=!0,checkActivePlaylist()&&vod_series_page.init("vod");break;case"series":this.dataLoaded.series=!0,checkActivePlaylist()&&vod_series_page.init("series")}},clickMainMenu:function(){var e=parseInt(localStorage.getItem(storage_id+"load_on_demand")),t=this.keys;switch(t.menu_selection){case 0:// live favorites
