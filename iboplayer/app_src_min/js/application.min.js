...
window.ongoingRequests||(window.ongoingRequests=[]);var t={type:"GET",headers:{},data:null},i=e.url,i={url:i,type:e.type||t.type,headers:e.headers||t.headers,data:e.data||t.data},s=("function"==typeof e.success&&(i.success=e.success),"function"==typeof e.error&&(i.error=e.error),
...
// Check if host_smasung_version is defined and not empty in host.js
...
MediaTrackPrevious:10232,MediaTrackNext:10233,Source:10072,RETURN:8,PLAY_PAUSE:463,MediaPlayPause:179},
...
o.push(a);else
// if show category
if(o.includes(a))for(var n=0;n<o.length;n++)if(o[n]==a){o.splice(n,1);break}localStorage.setItem(storage_id+settings.playlist.id+i+"_hiddens",JSON.stringify(o))},getCategories:function(t,i){var e=this.categories.filter(function(e){return i?!!t||!e.is_hide:t?"favourite"!==e.category_id&&"recent"!==e.category_id:!e.is_hide&&"favourite"!==e.category_id&&"recent"!==e.category_id});return e},setMovies:function(e){this.movies=e},insertMoviesToCategories:function(){
// Categorize movies
for(var d=this,t=this.stream_type,e=this.movies,i=this.categories,s={recent:{category_id:"recent",category_name:"Continue Watching",parent_id:0,movies:[],is_hide:!1},topRated:{category_id:"top_rated",category_name:"Top Rated",parent_id:0,movies:[],is_hide:!1},favourite:{category_id:"favourite",category_name:"Favourites",parent_id:0,movies:[],is_hide:!1},newlyAdded:{category_id:"newly_added",category_name:"Newly Added",parent_id:0,movies:[],is_hide:!1},undefined:{category_id:"undefined",category_name:"Uncategorized",parent_id:0,movies:[],is_hide:!1}},a=(
// Add undefined category to the list
i.push(s.undefined),g()),h=(this.saved_video_times=a,this.movie_key),o=v(),n=(this.favourite_ids=o,f(a)),r=[],l=[],c=[],_=[],u={},m=Math.floor(Date.now()/1e3),p=0;p<e.length;p++)y(e[p],u,n,o,r,l,c,_,m);
// Order recent movies based on watch progress
// Helper functions
function g(){var e=storage_id+settings.playlist.id+"_saved_"+t+"_times",e=localStorage.getItem(e);return e?JSON.parse(e):[]}function v(){var e=storage_id+settings.playlist.id+t+"_favourite",e=JSON.parse(localStorage.getItem(e));return e||[]}function f(e){return"xc"===settings.playlist.playlist_type?e.map(function(e){return parseInt(e.stream_id,10)}):e.map(function(e){return e.stream_id})}function y(e,t,i,s,a,o,n,r,l){void 0!==e.category_id&&"null"!==e.category_id&&null!==e.category_id||(e.category_id="undefined");var c=e.category_id.toString();t[c]||(t[c]=[]),t[c].push(e),e.is_recent=!1,-1!==i.indexOf(e[h])&&a.push(e),-1!==s.indexOf(e[h])&&("before"===d.favourite_insert_position?o.unshift(e):o.push(e)),e.rating&&!isNaN(parseFloat(e.rating))&&r.push(e),
// Check if the movie was added within the last 15 days
e.added&&b(e.added,l)&&n.push(e)}function b(e,t){var i=1296e3;return t-e<=i}function k(e,i){var s=[];return e.forEach(function(e){for(var t=0;t<i.length;t++)if(i[t].stream_id==e){s.unshift(i[t]),i.splice(t,1);break}}),s}function w(e,i){e.forEach(function(e){var t=e.category_id.toString();e.movies=i[t]||[]})}function C(e){for(var t=0;t<e.length;t++)if("undefined"===e[t].category_id&&0===e[t].movies.length){e.splice(t,1);break}}r=k(n,r),
// Assign movies to their respective categories
w(i,u),
// Assign special category movies
s.recent.movies=r,s.favourite.movies=l,s.newlyAdded.movies=c,s.topRated.movies=utilities.getTopRatedMovies(_)||[],null==s.topRated.movies&&(s.topRated.movies=[]),
// Add special categories at the beginning
i.unshift(s.newlyAdded),i.unshift(s.topRated),i.unshift(s.favourite),i.unshift(s.recent),
// Remove undefined category if empty
C(i),this.categories=i,this.movies=[]},getRecentOrFavouriteCategoryPosition:function(e){return"favourite"===e?1:0},getRecentOrFavouriteCategory:function(e){var e=this.getRecentOrFavouriteCategoryPosition(e);return this.categories[e]},setRecentOrFavouriteMovies:function(e,t){var i=this.stream_type,s=this.getRecentOrFavouriteCategoryPosition(t),a=(this.categories[s].movies=e,this.movie_key),s=e.map(function(e){return e[a]});"favourite"===t&&(this.favourite_ids=s),localStorage.setItem(storage_id+settings.playlist.id+i+"_"+t,JSON.stringify(s))},addRecentOrFavouriteMovie:function(e,t){// if added, it will be true
...
if(o.includes(a))for(var n=0;n<o.length;n++)if(o[n]==a){o.splice(n,1);break}localStorage.setItem(storage_id+settings.playlist.id+i+"_hiddens",JSON.stringify(o))},getCategories:function(t,i){var e=this.categories.filter(function(e){return i?!!t||!e.is_hide:t?"favourite"!==e.category_id&&"recent"!==e.category_id:!e.is_hide&&"favourite"!==e.category_id&&"recent"!==e.category_id});return e},setMovies:function(e){this.movies=e},insertMoviesToCategories:function(){var e=localStorage.getItem(storage_id+settings.playlist.id+"_category_orders"),e=e?JSON.parse(e):[],t=(this.category_orders=e,localStorage.getItem(storage_id+settings.playlist.id+"_channel_orders")),t=t?JSON.parse(t):{},i=(this.channel_orders=t,this.stream_type),s=this.movies,a=this.categories,o={category_id:"recent",category_name:"Recently Viewed",parent_id:0,movies:[],is_hide:!1},n={category_id:"favourite",category_name:"Favourites",parent_id:0,movies:[],is_hide:!1},r={category_id:"undefined",category_name:"Uncategorized",parent_id:0,movies:[],is_hide:!1},l=(a.push(r),this.movie_key),c=JSON.parse(localStorage.getItem(storage_id+settings.playlist.id+i+"_recent")),d=JSON.parse(localStorage.getItem(storage_id+settings.playlist.id+i+"_favourite")),c=null==c?[]:c,d=null==d?[]:d;this.favourite_ids=d;
// movies.map(function(movie){
for(var h=[],_=[],u=this,m={},p=0;p<s.length;p++){
// for(var i=0;i<100;i++){
var g=s[p],v=(void 0!==g.category_id&&"null"!=g.category_id&&null!=g.category_id||(g.category_id="undefined"),g.category_id.toString());void 0===m[v]?m[v]=[g]:m[v].push(g),g.is_recent=!1,c.includes(g[l])&&("before"===u.recent_insert_position?h.unshift(g):h.push(g),g.is_recent=!0),d.includes(g[l])&&("before"===u.favourite_insert_position?_.unshift(g):_.push(g))}for(var p=0;p<a.length;p++){// except favourite, and recent movies
var v=a[p].category_id.toString();a[p].movies=void 0===m[v]?[]:m[v]}o.movies=h,n.movies=_,a.unshift(n),a.unshift(o);
// categories.unshift(all_category);
for(var p=0;p<a.length;p++)if("undefined"===a[p].category_id){0==a[p].movies.length&&a.splice(p,1);break}for(var p=0;p<a.length;p++)if("undefined"===a[p].category_id){a[p].movies&&0==a[p].movies.length&&a.splice(p,1);break}for(var p=0;p<e.length;p++)for(y=0;y<a.length;y++)if(e[p].id==a[y].category_id){a=makeRearrangeArray(a,y,e[p].position);break}for(var p=0;p<a.length;p++)if("favourite"==a[p].category_id&&(this.favourite_position=p),"recent"==a[p].category_id&&(this.recent_position=p),t[a[p].category_id]){for(// rearrange started.
var f=t[a[p].category_id],s=a[p].movies,y=0;y<f.length;y++)for(var b=0;b<s.length;b++)if(f[y].id==s[b].stream_id&&f[y].name==s[b].name){s=makeRearrangeArray(s,b,f[y].position);break}a[p].movies=s}this.categories=a,this.movies=[]},updateRecentAndFavouritePosition:function(){for(var e=this.categories,t=0;t<e.length;t++)"favourite"===e[t].category_id&&(this.favourite_position=t),"recent"===e[t].category_id&&(this.recent_position=t)},getRecentOrFavouriteCategoryPosition:function(e){return this[e+"_position"]},getRecentOrFavouriteCategory:function(e){var e=this.getRecentOrFavouriteCategoryPosition(e);return this.categories[e]},setRecentOrFavouriteMovies:function(e,t){var i=this.stream_type,s=this.getRecentOrFavouriteCategoryPosition(t),a=(this.categories[s].movies=e,this.movie_key),s=e.map(function(e){return e[a]});"favourite"===t&&(this.favourite_ids=s),localStorage.setItem(storage_id+settings.playlist.id+i+"_"+t,JSON.stringify(s))},addRecentOrFavouriteMovie:function(e,t){// if added, it will be true
...
if(o.includes(a))for(var n=0;n<o.length;n++)if(o[n]==a){o.splice(n,1);break}localStorage.setItem(storage_id+settings.playlist.id+i+"_hiddens",JSON.stringify(o))},getCategories:function(t,i){var e=this.categories.filter(function(e){return i?!!t||!e.is_hide:t?"favourite"!==e.category_id&&"recent"!==e.category_id:!e.is_hide&&"favourite"!==e.category_id&&"recent"!==e.category_id});return e},setMovies:function(e){this.movies=e},insertMoviesToCategories:function(){
// Categorize series
for(var d=this,t=this.stream_type,e=this.movies,i=this.categories,s={recent:{category_id:"recent",category_name:"Recently Viewed",parent_id:0,movies:[],is_hide:!1},topRated:{category_id:"top_rated",category_name:"Top Rated",parent_id:0,movies:[],is_hide:!1},favourite:{category_id:"favourite",category_name:"Favourites",parent_id:0,movies:[],is_hide:!1},recentlyModified:{category_id:"recently_modified",category_name:"Recently Added/Updated",parent_id:0,movies:[],is_hide:!1},undefined:{category_id:"undefined",category_name:"Uncategorized",parent_id:0,movies:[],is_hide:!1}},h=(
// Add undefined category to the list
i.push(s.undefined),this.movie_key),a=g(),o=(this.favourite_ids=a,v()),n=(this.saved_video_times=o,f(o)),o=[],r=[],l=[],c=[],_=[],u={},m=Math.floor(Date.now()/1e3),p=0;p<e.length;p++)y(e[p],u,n,a,c,r,l,_,m);
// Order recent series based on watch progress
// Clear the series list
// Helper functions
function g(){var e=storage_id+settings.playlist.id+t+"_favourite",e=JSON.parse(localStorage.getItem(e));return e||[]}function v(){var e=storage_id+settings.playlist.id+"_saved_"+t+"_times",e=localStorage.getItem(e);return e?JSON.parse(e):[]}function f(e){return"xc"===settings.playlist.playlist_type?e.map(function(e){return parseInt(e.stream_id,10)}):e.map(function(e){return e.stream_id})}function y(e,t,i,s,a,o,n,r,l){void 0!==e.category_id&&"null"!=e.category_id&&null!=e.category_id||(e.category_id="undefined");var c=e.category_id.toString();t[c]||(t[c]=[]),t[c].push(e),e.is_recent=!1,-1!==i.indexOf(e[h])&&a.push(e),-1!==s.indexOf(e[h])&&("before"===d.favourite_insert_position?o.unshift(e):o.push(e)),e.rating&&!isNaN(parseFloat(e.rating))&&r.push(e),
// Check if the series was modified within the last 15 days
e.last_modified&&b(e.last_modified,l)&&n.push(e)}function b(e,t){var i=1296e3;return t-parseInt(e,10)<=i}function k(e,t){for(var i=[],s=0;s<e.length;s++)for(var a=0;a<t.length;a++)if(t[a].series_id==e[s]){i.unshift(t[a]),t.splice(a,1);break}return i}function w(e,t){for(var i=0;i<e.length;i++){var s=e[i].category_id.toString();e[i].movies=t[s]||[]}}function C(e){for(var t=0;t<e.length;t++)if("undefined"===e[t].category_id&&0==e[t].movies.length){e.splice(t,1);break}}o=k(n,c),
// Assign series to their respective categories
w(i,u),
// Assign special category series
s.recent.movies=o,s.favourite.movies=r,s.recentlyModified.movies=l,s.topRated.movies=utilities.getTopRatedMovies(_)||[],null==s.topRated.movies&&(s.topRated.movies=[]),
// Add special categories at the beginning
i.unshift(s.recentlyModified),i.unshift(s.topRated),i.unshift(s.favourite),i.unshift(s.recent),
// Remove undefined category if empty
C(i),this.categories=i,this.movies=[]},getRecentOrFavouriteCategoryPosition:function(e){return"favourite"===e?1:0},getRecentOrFavouriteCategory:function(e){var e=this.getRecentOrFavouriteCategoryPosition(e);return this.categories[e]},setRecentOrFavouriteMovies:function(e,t){var i=this.stream_type,s=this.getRecentOrFavouriteCategoryPosition(t),a=(this.categories[s].movies=e,this.movie_key),s=e.map(function(e){return e[a]});"favourite"===t&&(this.favourite_ids=s),localStorage.setItem(storage_id+settings.playlist.id+i+"_"+t,JSON.stringify(s))},addRecentOrFavouriteMovie:function(e,t){// if added, it will be true
...
createCategoriesDoms:function(){var e={live:LiveModel.getCategories(!0,!1),movies:VodModel.getCategories(!0,!1),series:SeriesModel.getCategories(!0,!1)},t={live:"",movies:"",series:""},i;
...
i=LiveModel.getCategories(!0,!1),LiveModel.saveHiddenCategories(e,!i[e].is_hide),this.toggleCategoryItem($(this.hide_categories_live_items[e]),i[e].is_hide);break;case 1:// Movies
i=VodModel.getCategories(!0,!1),VodModel.saveHiddenCategories(e,!i[e].is_hide),this.toggleCategoryItem($(this.hide_categories_movies_items[e]),i[e].is_hide);break;case 2:// Series
i=SeriesModel.getCategories(!0,!1),SeriesModel.saveHiddenCategories(e,!i[e].is_hide),this.toggleCategoryItem($(this.hide_categories_series_items[e]),i[e].is_hide)}},toggleCategoryItem:function(e,t){t?e.removeClass("checked"):e.addClass("checked")},
