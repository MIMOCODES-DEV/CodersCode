...
i.hide(),e.preventDefault()}}})}},QRCode,WEBSITE_URL=(function(){function t(e){this.mode=o.MODE_8BIT_BYTE,this.data=e,this.parsedData=[];for(var t=[],i=0,s=this.data.length;i<s;i++){var a=this.data.charCodeAt(i);65536<a?(t[0]=240|(1835008&a)>>>18,t[1]=128|(258048&a)>>>12,t[2]=128|(4032&a)>>>6,t[3]=128|63&a):2048<a?(t[0]=224|(61440&a)>>>12,t[1]=128|(4032&a)>>>6,t[2]=128|63&a):128<a?(t[0]=192|(1984&a)>>>6,t[1]=128|63&a):t[0]=a,this.parsedData=this.parsedData.concat(t)}this.parsedData.length!=this.data.length&&(this.parsedData.unshift(191),this.parsedData.unshift(187),this.parsedData.unshift(239))}function l(e,t){this.typeNumber=e,this.errorCorrectLevel=t,this.modules=null,this.moduleCount=0,this.dataCache=null,this.dataList=[]}function g(e,t){if(null==e.length)throw new Error(e.length+"/"+t);for(var i=0;i<e.length&&0==e[i];)i++;this.num=new Array(e.length-i+t);for(var s=0;s<e.length-i;s++)this.num[s]=e[s+i]}function d(e,t){this.totalCount=e,this.dataCount=t}function c(){this.buffer=[],this.length=0}function e(){return"undefined"!=typeof CanvasRenderingContext2D}function s(){var e=!1,t=navigator.userAgent;return/android/i.test(t)&&(e=!0,aMat=t.toString().match(/android ([0-9]\.[0-9])/i),aMat)&&aMat[1]&&(e=parseFloat(aMat[1])),e}function i(e,t){for(var i=1,s=r(e),a=0,o=C.length;a<=o;a++){var n=0;switch(t){case h.L:n=C[a][0];break;case h.M:n=C[a][1];break;case h.Q:n=C[a][2];break;case h.H:n=C[a][3]}if(s<=n)break;i++}if(C.length<i)throw new Error("Too long data");return i}function r(e){var t=encodeURI(e).toString().replace(/\%[0-9a-fA-F]{2}/g,"a");return t.length+(t.length!=e?3:0)}t.prototype={getLength:function(){return this.parsedData.length},write:function(e){for(var t=0,i=this.parsedData.length;t<i;t++)e.put(this.parsedData[t],8)}},l.prototype={addData:function(e){var e=new t(e);this.dataList.push(e),this.dataCache=null},isDark:function(e,t){if(e<0||this.moduleCount<=e||t<0||this.moduleCount<=t)throw new Error(e+","+t);return this.modules[e][t]},getModuleCount:function(){return this.moduleCount},make:function(){this.makeImpl(!1,this.getBestMaskPattern())},makeImpl:function(e,t){this.moduleCount=4*this.typeNumber+17,this.modules=new Array(this.moduleCount);for(var i=0;i<this.moduleCount;i++){this.modules[i]=new Array(this.moduleCount);for(var s=0;s<this.moduleCount;s++)this.modules[i][s]=null}this.setupPositionProbePattern(0,0),this.setupPositionProbePattern(this.moduleCount-7,0),this.setupPositionProbePattern(0,this.moduleCount-7),this.setupPositionAdjustPattern(),this.setupTimingPattern(),this.setupTypeInfo(e,t),7<=this.typeNumber&&this.setupTypeNumber(e),null==this.dataCache&&(this.dataCache=l.createData(this.typeNumber,this.errorCorrectLevel,this.dataList)),this.mapData(this.dataCache,t)},setupPositionProbePattern:function(e,t){for(var i=-1;i<=7;i++)if(!(e+i<=-1||this.moduleCount<=e+i))for(var s=-1;s<=7;s++)t+s<=-1||this.moduleCount<=t+s||(this.modules[e+i][t+s]=0<=i&&i<=6&&(0==s||6==s)||0<=s&&s<=6&&(0==i||6==i)||2<=i&&i<=4&&2<=s&&s<=4)},getBestMaskPattern:function(){for(var e=0,t=0,i=0;i<8;i++){this.makeImpl(!0,i);var s=b.getLostPoint(this);(0==i||s<e)&&(e=s,t=i)}return t},createMovieClip:function(e,t,i){var s=e.createEmptyMovieClip(t,i),a=1;this.make();for(var o=0;o<this.modules.length;o++)for(var n=+o,r=0;r<this.modules[o].length;r++){var l=+r,c=this.modules[o][r];c&&(s.beginFill(0,100),s.moveTo(l,n),s.lineTo(1+l,n),s.lineTo(1+l,1+n),s.lineTo(l,1+n),s.endFill())}return s},setupTimingPattern:function(){for(var e=8;e<this.moduleCount-8;e++)null==this.modules[e][6]&&(this.modules[e][6]=0==e%2);for(var t=8;t<this.moduleCount-8;t++)null==this.modules[6][t]&&(this.modules[6][t]=0==t%2)},setupPositionAdjustPattern:function(){for(var e=b.getPatternPosition(this.typeNumber),t=0;t<e.length;t++)for(var i=0;i<e.length;i++){var s=e[t],a=e[i];if(null==this.modules[s][a])for(var o=-2;o<=2;o++)for(var n=-2;n<=2;n++)this.modules[s+o][a+n]=-2==o||2==o||-2==n||2==n||0==o&&0==n}},setupTypeNumber:function(e){for(var t=b.getBCHTypeNumber(this.typeNumber),i=0;i<18;i++){var s=!e&&1==(1&t>>i);this.modules[Math.floor(i/3)][i%3+this.moduleCount-8-3]=s}for(var i=0;i<18;i++){var s=!e&&1==(1&t>>i);this.modules[i%3+this.moduleCount-8-3][Math.floor(i/3)]=s}},setupTypeInfo:function(e,t){for(var t=this.errorCorrectLevel<<3|t,i=b.getBCHTypeInfo(t),s=0;s<15;s++){var a=!e&&1==(1&i>>s);s<6?this.modules[s][8]=a:s<8?this.modules[s+1][8]=a:this.modules[this.moduleCount-15+s][8]=a}for(var s=0;s<15;s++){var a=!e&&1==(1&i>>s);s<8?this.modules[8][this.moduleCount-s-1]=a:s<9?this.modules[8][15-s-1+1]=a:this.modules[8][15-s-1]=a}this.modules[this.moduleCount-8][8]=!e},mapData:function(e,t){for(var i=-1,s=this.moduleCount-1,a=7,o=0,n=this.moduleCount-1;0<n;n-=2)for(6==n&&n--;;){for(var r=0,l,c;r<2;r++)null==this.modules[s][n-r]&&(l=!1,o<e.length&&(l=1==(1&e[o]>>>a)),c=b.getMask(t,s,n-r),c&&(l=!l),this.modules[s][n-r]=l,a--,-1==a)&&(o++,a=7);if(s+=i,s<0||this.moduleCount<=s){s-=i,i=-i;break}}}},l.PAD0=236,l.PAD1=17,l.createData=function(e,t,i){for(var s=d.getRSBlocks(e,t),a=new c,o=0;o<i.length;o++){var n=i[o];a.put(n.mode,4),a.put(n.getLength(),b.getLengthInBits(n.mode,e)),n.write(a)}for(var r=0,o=0;o<s.length;o++)r+=s[o].dataCount;if(a.getLengthInBits()>8*r)throw new Error("code length overflow. ("+a.getLengthInBits()+">"+8*r+")");for(a.getLengthInBits()+4<=8*r&&a.put(0,4);0!=a.getLengthInBits()%8;)a.putBit(!1);for(;!(a.getLengthInBits()>=8*r||(a.put(l.PAD0,8),a.getLengthInBits()>=8*r));)a.put(l.PAD1,8);return l.createBytes(a,s)},l.createBytes=function(e,t){for(var i=0,s=0,a=0,o=new Array(t.length),n=new Array(t.length),r=0;r<t.length;r++){var l=t[r].dataCount,c=t[r].totalCount-l,s=Math.max(s,l),a=Math.max(a,c);o[r]=new Array(l);for(var d=0;d<o[r].length;d++)o[r][d]=255&e.buffer[d+i];i+=l;var l=b.getErrorCorrectPolynomial(c),c=new g(o[r],l.getLength()-1),h=c.mod(l);n[r]=new Array(l.getLength()-1);for(var d=0;d<n[r].length;d++){var _=d+h.getLength()-n[r].length;n[r][d]=0<=_?h.get(_):0}}for(var u=0,d=0;d<t.length;d++)u+=t[d].totalCount;for(var m=new Array(u),p=0,d=0;d<s;d++)for(var r=0;r<t.length;r++)d<o[r].length&&(m[p++]=o[r][d]);for(var d=0;d<a;d++)for(var r=0;r<t.length;r++)d<n[r].length&&(m[p++]=n[r][d]);return m};for(var o={MODE_NUMBER:1,MODE_ALPHA_NUM:2,MODE_8BIT_BYTE:4,MODE_KANJI:8},h={L:1,M:0,Q:3,H:2},a,n=0,_=1,u=2,m=3,p=4,v=5,f=6,y=7,b={PATTERN_POSITION_TABLE:[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],G15:1335,G18:7973,G15_MASK:21522,getBCHTypeInfo:function(e){for(var t=e<<10;0<=b.getBCHDigit(t)-b.getBCHDigit(b.G15);)t^=b.G15<<b.getBCHDigit(t)-b.getBCHDigit(b.G15);return(e<<10|t)^b.G15_MASK},getBCHTypeNumber:function(e){for(var t=e<<12;0<=b.getBCHDigit(t)-b.getBCHDigit(b.G18);)t^=b.G18<<b.getBCHDigit(t)-b.getBCHDigit(b.G18);return e<<12|t},getBCHDigit:function(e){for(var t=0;0!=e;)t++,e>>>=1;return t},getPatternPosition:function(e){return b.PATTERN_POSITION_TABLE[e-1]},getMask:function(e,t,i){switch(e){case 0:return 0==(t+i)%2;case 1:return 0==t%2;case 2:return 0==i%3;case 3:return 0==(t+i)%3;case 4:return 0==(Math.floor(t/2)+Math.floor(i/3))%2;case 5:return 0==t*i%2+t*i%3;case 6:return 0==(t*i%2+t*i%3)%2;case 7:return 0==(t*i%3+(t+i)%2)%2;default:throw new Error("bad maskPattern:"+e)}},getErrorCorrectPolynomial:function(e){for(var t=new g([1],0),i=0;i<e;i++)t=t.multiply(new g([1,k.gexp(i)],0));return t},getLengthInBits:function(e,t){if(1<=t&&t<10)switch(e){case o.MODE_NUMBER:return 10;case o.MODE_ALPHA_NUM:return 9;case o.MODE_8BIT_BYTE:case o.MODE_KANJI:return 8;default:throw new Error("mode:"+e)}else if(t<27)switch(e){case o.MODE_NUMBER:return 12;case o.MODE_ALPHA_NUM:return 11;case o.MODE_8BIT_BYTE:return 16;case o.MODE_KANJI:return 10;default:throw new Error("mode:"+e)}else{if(!(t<41))throw new Error("type:"+t);switch(e){case o.MODE_NUMBER:return 14;case o.MODE_ALPHA_NUM:return 13;case o.MODE_8BIT_BYTE:return 16;case o.MODE_KANJI:return 12;default:throw new Error("mode:"+e)}}},getLostPoint:function(e){for(var t=e.getModuleCount(),i=0,s=0;s<t;s++)for(var a=0;a<t;a++){for(var o=0,n=e.isDark(s,a),r=-1;r<=1;r++)if(!(s+r<0||t<=s+r))for(var l=-1;l<=1;l++)a+l<0||t<=a+l||0==r&&0==l||n!=e.isDark(s+r,a+l)||o++;5<o&&(i+=3+o-5)}for(var s=0;s<t-1;s++)for(var a=0;a<t-1;a++){var c=0;e.isDark(s,a)&&c++,e.isDark(s+1,a)&&c++,e.isDark(s,a+1)&&c++,e.isDark(s+1,a+1)&&c++,0!=c&&4!=c||(i+=3)}for(var s=0;s<t;s++)for(var a=0;a<t-6;a++)e.isDark(s,a)&&!e.isDark(s,a+1)&&e.isDark(s,a+2)&&e.isDark(s,a+3)&&e.isDark(s,a+4)&&!e.isDark(s,a+5)&&e.isDark(s,a+6)&&(i+=40);for(var a=0;a<t;a++)for(var s=0;s<t-6;s++)e.isDark(s,a)&&!e.isDark(s+1,a)&&e.isDark(s+2,a)&&e.isDark(s+3,a)&&e.isDark(s+4,a)&&!e.isDark(s+5,a)&&e.isDark(s+6,a)&&(i+=40);for(var d=0,a=0;a<t;a++)for(var s=0;s<t;s++)e.isDark(s,a)&&d++;var h=Math.abs(100*d/t/t-50)/5;return i+10*h}},k={glog:function(e){if(e<1)throw new Error("glog("+e+")");return k.LOG_TABLE[e]},gexp:function(e){for(;e<0;)e+=255;for(;256<=e;)e-=255;return k.EXP_TABLE[e]},EXP_TABLE:new Array(256),LOG_TABLE:new Array(256)},w=0;w<8;w++)k.EXP_TABLE[w]=1<<w;for(var w=8;w<256;w++)k.EXP_TABLE[w]=k.EXP_TABLE[w-4]^k.EXP_TABLE[w-5]^k.EXP_TABLE[w-6]^k.EXP_TABLE[w-8];for(var w=0;w<255;w++)k.LOG_TABLE[k.EXP_TABLE[w]]=w;g.prototype={get:function(e){return this.num[e]},getLength:function(){return this.num.length},multiply:function(e){for(var t=new Array(this.getLength()+e.getLength()-1),i=0;i<this.getLength();i++)for(var s=0;s<e.getLength();s++)t[i+s]^=k.gexp(k.glog(this.get(i))+k.glog(e.get(s)));return new g(t,0)},mod:function(e){if(this.getLength()-e.getLength()<0)return this;for(var t=k.glog(this.get(0))-k.glog(e.get(0)),i=new Array(this.getLength()),s=0;s<this.getLength();s++)i[s]=this.get(s);for(var s=0;s<e.getLength();s++)i[s]^=k.gexp(k.glog(e.get(s))+t);return new g(i,0).mod(e)}},d.RS_BLOCK_TABLE=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],d.getRSBlocks=function(e,t){var i=d.getRsBlockTable(e,t);if(null==i)throw new Error("bad rs block @ typeNumber:"+e+"/errorCorrectLevel:"+t);for(var s=i.length/3,a=[],o=0;o<s;o++)for(var n=i[3*o+0],r=i[3*o+1],l=i[3*o+2],c=0;c<n;c++)a.push(new d(r,l));return a},d.getRsBlockTable=function(e,t){switch(t){case h.L:return d.RS_BLOCK_TABLE[4*(e-1)+0];case h.M:return d.RS_BLOCK_TABLE[4*(e-1)+1];case h.Q:return d.RS_BLOCK_TABLE[4*(e-1)+2];case h.H:return d.RS_BLOCK_TABLE[4*(e-1)+3];default:return}},c.prototype={get:function(e){var t=Math.floor(e/8);return 1==(1&this.buffer[t]>>>7-e%8)},put:function(e,t){for(var i=0;i<t;i++)this.putBit(1==(1&e>>>t-i-1))},getLengthInBits:function(){return this.length},putBit:function(e){var t=Math.floor(this.length/8);this.buffer.length<=t&&this.buffer.push(0),e&&(this.buffer[t]|=128>>>this.length%8),this.length++}};var C=[[17,14,11,7],[32,26,20,14],[53,42,32,24],[78,62,46,34],[106,84,60,44],[134,106,74,58],[154,122,86,64],[192,152,108,84],[230,180,130,98],[271,213,151,119],[321,251,177,137],[367,287,203,155],[425,331,241,177],[458,362,258,194],[520,412,292,220],[586,450,322,250],[644,504,364,280],[718,560,394,310],[792,624,442,338],[858,666,482,382],[929,711,509,403],[1003,779,565,439],[1091,857,611,461],[1171,911,661,511],[1273,997,715,535],[1367,1059,751,593],[1465,1125,805,625],[1528,1190,868,658],[1628,1264,908,698],[1732,1370,982,742],[1840,1452,1030,790],[1952,1538,1112,842],[2068,1628,1168,898],[2188,1722,1228,958],[2303,1809,1283,983],[2431,1911,1351,1051],[2563,1989,1423,1093],[2699,2099,1499,1139],[2809,2213,1579,1219],[2953,2331,1663,1273]],$=($=function(e,t){this._el=e,this._htOption=t},$.prototype.draw=function(e){function t(e,t){var i=document.createElementNS("http://www.w3.org/2000/svg",e),s;for(s in t)t.hasOwnProperty(s)&&i.setAttribute(s,t[s]);return i}var i=this._htOption,s=this._el,a=e.getModuleCount(),o=(Math.floor(i.width/a),Math.floor(i.height/a),this.clear(),t("svg",{viewBox:"0 0 "+String(a)+" "+String(a),width:"100%",height:"100%",fill:i.colorLight}));o.setAttributeNS("http://www.w3.org/2000/xmlns/","xmlns:xlink","http://www.w3.org/1999/xlink"),s.appendChild(o),o.appendChild(t("rect",{fill:i.colorDark,width:"1",height:"1",id:"template"}));for(var n=0,r;n<a;n++)for(var l=0;l<a;l++)e.isDark(n,l)&&(r=t("use",{x:String(n),y:String(l)}),r.setAttributeNS("http://www.w3.org/1999/xlink","href","#template"),o.appendChild(r))},$.prototype.clear=function(){for(;this._el.hasChildNodes();)this._el.removeChild(this._el.lastChild)},$),S="svg"===document.documentElement.tagName.toLowerCase(),M=S?$:e()?function(){function e(){this._elImage.src=this._elCanvas.toDataURL("image/png"),this._elImage.style.display="block",this._elCanvas.style.display="none"}function t(e,t){var i=this,t,e,s;i._fFail=t,i._fSuccess=e,null===i._bSupportDataURI?(t=document.createElement("img"),e=function(){i._bSupportDataURI=!1,i._fFail&&_fFail.call(i)},s=function(){i._bSupportDataURI=!0,i._fSuccess&&i._fSuccess.call(i)},t.onabort=e,t.onerror=e,t.onload=s,t.src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg=="):!0===i._bSupportDataURI&&i._fSuccess?i._fSuccess.call(i):!1===i._bSupportDataURI&&i._fFail&&i._fFail.call(i)}var c,d,i=(this._android&&this._android<=2.1&&(c=1/window.devicePixelRatio,d=CanvasRenderingContext2D.prototype.drawImage,CanvasRenderingContext2D.prototype.drawImage=function(e,t,i,s,a,o,n,r){if("nodeName"in e&&/img/i.test(e.nodeName))for(var l=arguments.length-1;1<=l;l--)arguments[l]=arguments[l]*c;else void 0===r&&(arguments[1]*=c,arguments[2]*=c,arguments[3]*=c,arguments[4]*=c);d.apply(this,arguments)}),function(e,t){this._bIsPainted=!1,this._android=s(),this._htOption=t,this._elCanvas=document.createElement("canvas"),this._elCanvas.width=t.width,this._elCanvas.height=t.height,e.appendChild(this._elCanvas),this._el=e,this._oContext=this._elCanvas.getContext("2d"),this._bIsPainted=!1,this._elImage=document.createElement("img"),this._elImage.style.display="none",this._el.appendChild(this._elImage),this._bSupportDataURI=null});return i.prototype.draw=function(e){var t=this._elImage,i=this._oContext,s=this._htOption,a=e.getModuleCount(),o=s.width/a,n=s.height/a,r=Math.round(o),l=Math.round(n);t.style.display="none",this.clear();for(var c=0;c<a;c++)for(var d=0;d<a;d++){var h=e.isDark(c,d),_=d*o,u=c*n;i.strokeStyle=h?s.colorDark:s.colorLight,i.lineWidth=1,i.fillStyle=h?s.colorDark:s.colorLight,i.fillRect(_,u,o,n),i.strokeRect(Math.floor(_)+.5,Math.floor(u)+.5,r,l),i.strokeRect(Math.ceil(_)-.5,Math.ceil(u)-.5,r,l)}this._bIsPainted=!0},i.prototype.makeImage=function(){this._bIsPainted&&t.call(this,e)},i.prototype.isPainted=function(){return this._bIsPainted},i.prototype.clear=function(){this._oContext.clearRect(0,0,this._elCanvas.width,this._elCanvas.height),this._bIsPainted=!1},i.prototype.round=function(e){return e&&Math.floor(1e3*e)/1e3},i}():(S=function(e,t){this._el=e,this._htOption=t},S.prototype.draw=function(e){for(var t=this._htOption,i=this._el,s=e.getModuleCount(),a=Math.floor(t.width/s),o=Math.floor(t.height/s),n=['<table style="border:0;border-collapse:collapse;">'],r=0;r<s;r++){n.push("<tr>");for(var l=0;l<s;l++)n.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:'+a+"px;height:"+o+"px;background-color:"+(e.isDark(r,l)?t.colorDark:t.colorLight)+';"></td>');n.push("</tr>")}n.push("</table>"),i.innerHTML=n.join("");var i=i.childNodes[0],c=(t.width-i.offsetWidth)/2,d=(t.height-i.offsetHeight)/2;0<c&&0<d&&(i.style.margin=d+"px "+c+"px")},S.prototype.clear=function(){this._el.innerHTML=""},S),S,$;QRCode=function(e,t){if(this._htOption={width:256,height:256,typeNumber:4,colorDark:"#000000",colorLight:"#ffffff",correctLevel:h.H},"string"==typeof t&&(t={text:t}),t)for(var i in t)this._htOption[i]=t[i];"string"==typeof e&&(e=document.getElementById(e)),this._android=s(),this._el=e,this._oQRCode=null,this._oDrawing=new M(this._el,this._htOption),this._htOption.text&&this.makeCode(this._htOption.text)},QRCode.prototype.makeCode=function(e){this._oQRCode=new l(i(e,this._htOption.correctLevel),this._htOption.correctLevel),this._oQRCode.addData(e),this._oQRCode.make(),this._el.title=e,this._oDrawing.draw(this._oQRCode),this.makeImage()},QRCode.prototype.makeImage=function(){"function"==typeof this._oDrawing.makeImage&&(!this._android||3<=this._android)&&this._oDrawing.makeImage()},QRCode.prototype.clear=function(){this._oDrawing.clear()},QRCode.CorrectLevel=h}(),"https://iboplayer.com");
...
return(10<=s.length?s:t).slice(0,10)}},clampNumber:function(e,t,i){return Math.max(t,Math.min(e,i))}},settings={bg_img_file:"",bg_img_name:"",playlist_id:0,playlist:{},vod_sort:"default",// or a-z, z-a, rating, number
...
var clearCachedMoviesInfo=function(){storageMoviesInfo&&(storageMoviesInfo={},localStorage.removeItem(storage_id+"saved-movie-info"))},media_player;
/**
...
var t=new QRCode(t[0],{text:e,width:i.width||128,height:i.height||128,colorDark:i.colorDark||"#000000",colorLight:i.colorLight||"#ffffff",correctLevel:QRCode.CorrectLevel.M});return t}function getHostVersion(){
...
for(var s=null==s?[]:JSON.parse(s),o={recent:{category_id:"recent",category_name:"Continue Watching",parent_id:0,movies:[],is_hide:a("recent")},topRated:{category_id:"top_rated",category_name:"Top Rated",parent_id:0,movies:[],is_hide:a("top_rated")},favourite:{category_id:"favourite",category_name:"Favourites",parent_id:0,movies:[],is_hide:a("favourite")},newlyAdded:{category_id:"newly_added",category_name:"Newly Added",parent_id:0,movies:[],is_hide:a("newly_added")},undefined:{category_id:"undefined",category_name:"Uncategorized",parent_id:0,movies:[],is_hide:a("undefined")}},n={category_id:"all",category_name:"Search All Movies",parent_id:0,movies:[],is_hide:!1},r=(
// Add undefined category to the list
i.push(o.undefined),{}),l=0;l<i.length;l++){var c=(i[l].category_name||"").toLowerCase();(c.includes("xxx")||c.includes("adult")||c.includes("porn")||c.includes("sex"))&&(r[i[l].category_id]=!0)}function h(e){return!0===r[e]}
// Retrieve and parse saved video progress
// Categorize movies
for(var _=w(),u=(this.saved_video_times=_,this.movie_key),m=C(),p=(this.favourite_ids=m,$(_)),g=[],v=[],f=[],y=[],b={},k=Math.floor(Date.now()/1e3),l=0;l<e.length;l++)S(e[l],b,p,m,g,v,f,y,k);
// Order recent movies based on watch progress
// Helper functions
function w(){var e=storage_id+settings.playlist.id+"_saved_"+t+"_times",e=localStorage.getItem(e);return e?JSON.parse(e):[]}function C(){var e=storage_id+settings.playlist.id+t+"_favourite",e=JSON.parse(localStorage.getItem(e));return e||[]}function $(e){return"xc"===settings.playlist.playlist_type?e.map(function(e){return parseInt(e.stream_id,10)}):e.map(function(e){return e.stream_id})}function S(e,t,i,s,a,o,n,r,l){void 0!==e.category_id&&"null"!==e.category_id&&null!==e.category_id||(e.category_id="undefined");var c=e.category_id.toString(),t=(t[c]||(t[c]=[]),t[c].push(e),e.is_recent=!1,-1!==i.indexOf(e[u])&&a.push(e),-1!==s.indexOf(e[u])&&("before"===d.favourite_insert_position?o.unshift(e):o.push(e)),h(c));t||!e.rating||isNaN(parseFloat(e.rating))||r.push(e),
// Check if the movie was added within the last 15 days
!t&&e.added&&M(e.added,l)&&n.push(e)}function M(e,t){var i=1296e3;return t-e<=i}function B(e,i){var s=[];return e.forEach(function(e){for(var t=0;t<i.length;t++)if(i[t].stream_id==e){s.unshift(i[t]),i.splice(t,1);break}}),s}function T(e,i){e.forEach(function(e){var t=e.category_id.toString();e.movies=i[t]||[]})}function x(e){for(var t=0;t<e.length;t++)if("undefined"===e[t].category_id&&0===e[t].movies.length){e.splice(t,1);break}}g=B(p,g),
...
i.unshift(o.newlyAdded),i.unshift(o.topRated),i.unshift(o.favourite),i.unshift(o.recent),i.unshift(n),
// Remove undefined category if empty
x(i),this.categories=i,this.movies=[]},getRecentOrFavouriteCategoryPosition:function(e){return"favourite"===e?2:1},getRecentOrFavouriteCategory:function(e){var e=this.getRecentOrFavouriteCategoryPosition(e);return this.categories[e]},setRecentOrFavouriteMovies:function(e,t){var i=this.stream_type,s=this.getRecentOrFavouriteCategoryPosition(t),a=(this.categories[s].movies=e,this.movie_key),s=e.map(function(e){return e[a]});"favourite"===t&&(this.favourite_ids=s),localStorage.setItem(storage_id+settings.playlist.id+i+"_"+t,JSON.stringify(s))},addRecentOrFavouriteMovie:function(e,t){// if added, it will be true
...
// Add undefined category to the list
i.push(o.undefined),this.movie_key),r=y(),l=(this.favourite_ids=r,b()),c=(this.saved_video_times=l,k(l)),l=[],_=[],u=[],m=[],p=[],g={},v=Math.floor(Date.now()/1e3),f=0;f<e.length;f++)w(e[f],g,c,r,m,_,u,p,v);
// Order recent series based on watch progress
// Clear the series list
// Helper functions
function y(){var e=storage_id+settings.playlist.id+t+"_favourite",e=JSON.parse(localStorage.getItem(e));return e||[]}function b(){var e=storage_id+settings.playlist.id+"_saved_"+t+"_times",e=localStorage.getItem(e);return e?JSON.parse(e):[]}function k(e){return"xc"===settings.playlist.playlist_type?e.map(function(e){return parseInt(e.stream_id,10)}):e.map(function(e){return e.stream_id})}function w(e,t,i,s,a,o,n,r,l){void 0!==e.category_id&&"null"!=e.category_id&&null!=e.category_id||(e.category_id="undefined");var c=e.category_id.toString();t[c]||(t[c]=[]),t[c].push(e),e.is_recent=!1,-1!==i.indexOf(e[h])&&a.push(e),-1!==s.indexOf(e[h])&&("before"===d.favourite_insert_position?o.unshift(e):o.push(e)),e.rating&&!isNaN(parseFloat(e.rating))&&r.push(e),
// Check if the series was modified within the last 15 days
e.last_modified&&C(e.last_modified,l)&&n.push(e)}function C(e,t){var i=1296e3;return t-parseInt(e,10)<=i}function $(e,t){for(var i=[],s=0;s<e.length;s++)for(var a=0;a<t.length;a++)if(t[a].series_id==e[s]){i.unshift(t[a]),t.splice(a,1);break}return i}function S(e,t){for(var i=0;i<e.length;i++){var s=e[i].category_id.toString();e[i].movies=t[s]||[]}}function M(e){for(var t=0;t<e.length;t++)if("undefined"===e[t].category_id&&0==e[t].movies.length){e.splice(t,1);break}}l=$(c,m),
...
// Add special categories at the beginning
i.unshift(o.recentlyModified),i.unshift(o.topRated),i.unshift(o.favourite),i.unshift(o.recent),i.unshift(n),
// Remove undefined category if empty
...
for(var i=this.getRecentOrFavouriteCategory(t),s=i.movies,a=!1,o=this.movie_key,i=!1,n=0,r,r,s;n<s.length;n++)if(s[n][o]==e[o]){a=!0;break}return a||(r=this[t+"_insert_position"],"before"===r?s.unshift(e):s.push(e),r=this[t+"_movie_count"],s=s.splice(0,r),this.setRecentOrFavouriteMovies(s,t),i=!0),i},removeRecentOrFavouriteMovie:function(e,t){for(var i=this.getRecentOrFavouriteCategory(t).movies,s=this.movie_key,a=!1,o=0;o<i.length;o++)if(i[o][s]==e){i.splice(o,1),a=!0;break}return this.setRecentOrFavouriteMovies(i,t),a}},playlist_page={initiated:!1,keys:{focused_part:"playlist_selection",playlist_selection:0,bottom_menu_selection:0,delete_confirmation_selection:0},playlist_doms:[],playlist_delete_btn_doms:[],auto_switch_toggle_value_dom:$(".playlist-page-auto-switch-toggle-value"),auto_start_toggle_value_dom:$(".playlist-page-auto-start-toggle-value"),bottom_menu_doms:$(".playlists-page-btn"),is_loading:!1,tried_panel_indexes:[],prev_route:"home-page",is_app_init:!1,is_playlist_error:!1,current_playlist_info_xhr:null,current_playlist_info_index:null,init:function(e){var o=this,n,r,l;this.prev_route=e,generateQRCode(WEBSITE_URL+"/device/login?mac_address="+mac_address,$("#playlists-qr")),this.is_app_init="app-init"===e,this.is_playlist_error="login-page"===e,current_route="playlist-page",this.tried_panel_indexes=[],this.initiated||(n="",r=settings.playlist_id,l=["#282828"],playlist_urls.map(function(e,t){var i=r===e.id,s=(o.is_app_init&&(i=!1),svg_icons.getIcon("trash","","width: 2rem; height: 2rem;")),a=l[t%l.length],a="background-image: linear-gradient(180deg, "+a+" 40%, #000 150%)",i='<div class="playlist-state '+(i?"playing":"")+'">CURRENT</div>';n+='          <div            class="playlist-item-wrapper"            onmouseenter="playlist_page.hoverPlayListItem('+t+')"            onclick="playlist_page.changePlaylist('+t+')"          >            <div class="playlist-item-delete-btn">'+s+'</div>            <div class="playlist-item-delete-confirmation">              <div class="playlist-delete-confirm-btn">✓</div>              <div class="playlist-delete-cancel-btn">✕</div>            </div>            <div class="playlist-item-icon-wrapper" style="'+a+'">              <div class="playlist-item-icon">                <img src="'+HOST+'app_src_min/images/logo.png" />              </div>            </div>            <div class="playlist-info">              <div class="playlist-name-container">                <div class="playlist-name">'+e.playlist_name+"</div>                "+i+'              </div>              <div class="playlist-exp-date" style="display: none;"></div>            </div>          </div>'}),this.initiated=!0,$("#playlist-items-container").html(n),this.playlist_doms=$(".playlist-item-wrapper"),this.playlist_delete_btn_doms=$(".playlist-item-delete-btn"),this.keys.playlist_selection=0),$("#home-page").addClass("hide"),$("#playlists-page").removeClass("hide"),this.processServerProvidedPlaylistInfo(),this.cleanupOldPlaylistsInfo(),this.updateAllPlaylistsInfoUI(),this.updateCurrentPlaylistUI(),this.setupAutoSwitchToggle(),this.setupAutoStartToggle(),this.hoverPlayListItem(this.keys.playlist_selection)},updateCurrentPlaylistUI:function(){var e=settings.playlist_id;$(this.playlist_doms).find(".playlist-state").removeClass("playing");for(var t=0;t<playlist_urls.length;t++)if(playlist_urls[t].id==e){$($(this.playlist_doms[t]).find(".playlist-state")).addClass("playing");break}},clearActiveStyles:function(){$(this.playlist_doms).removeClass("active outlined deleting"),$(this.playlist_delete_btn_doms).removeClass("active"),$(this.bottom_menu_doms).removeClass("active")},hoverPlayListItem:function(e){var t=this.keys;t.focused_part="playlist_selection",t.playlist_selection=e,this.clearActiveStyles(),this.hideDeleteConfirmation(),$(this.playlist_doms[e]).addClass("active outlined"),moveScrollPosition($("#playlist-items-container"),this.playlist_doms[e],"vertical",!1),this.fetchAndStorePlaylistInfo(e)},processServerProvidedPlaylistInfo:function(){
...
var i=playlist_urls[e],t=this.getStoredPlaylistInfo(i);if(t&&t.fetched_at){var s=new Date,t=new Date(t.fetched_at),s=(s-t)/6e4;if(s<5)return void(this.current_playlist_info_index=null)}this.current_playlist_info_index=e;var a=this,t=i.url,s,e;0!==t.indexOf("http://")&&0!==t.indexOf("https://")&&(t="http://"+t),"xc"===i.playlist_type&&i.username&&i.password&&i.url?(s="/"===t.charAt(t.length-1)?t.slice(0,-1):t,e=s+"/player_api.php?username="+i.username+"&password="+i.password,this.current_playlist_info_xhr=api({method:"get",url:e,headers:{Accept:"application/json"},timeout:1e4,success:function(e){var t=a.getPlaylistStorageKey(i),e={playlist_type:"xc",fetched_at:(new Date).toISOString(),expiry_date:e.user_info&&e.user_info.exp_date?e.user_info.exp_date:null,status:e.user_info&&e.user_info.status?e.user_info.status:"Unknown",auth:e.user_info&&e.user_info.auth?1==e.user_info.auth?"Active":"Inactive":"Unknown"};a.storePlaylistInfo(t,e),a.updateAllPlaylistsInfoUI(),
// Send playlist info to backend
a.sendPlaylistInfoToBackend(i,e),a.current_playlist_info_xhr=null,a.current_playlist_info_index=null},error:function(e,t,i){a.current_playlist_info_xhr=null,a.current_playlist_info_index=null}})):(i.playlist_type,this.current_playlist_info_index=null)}},getPlaylistStorageKey:function(e){for(
...
this.showPlaylistsQRCodeModal()}},setupAutoStartToggle:function(){
...
handleMenuClick:function(){var e=this.keys,t,t;switch(e.focused_part){case"category_selection":0==e.category_selection?(clearTimeout(this.idleOnChannelTimer),this.Exit("search-page")):(t=this.categories[e.category_selection],t=checkForAdult(t,"category",[],!0),t?parent_confirm_page.init(current_route):(this.showCategoryChannels(),this.toggleRearrangeMode(!1)));break;case"full_screen":this.full_screen_video=!1,this.zoomInOut(),this.setupZoomOnIdleTimer();break;case"channel_selection":
...
this.hoverChannel(s.channel_selection)}break;case"channel_nav":0<e&&(this.clearLiveSettingsButtonFocus(),$(this.channel_nav_doms).removeClass("active"),this.hoverLiveSettingsButton(s.live_settings_button_selection),s.focused_part="channel_nav_settings");break;case"channel_nav_settings":e<0?(this.clearLiveSettingsButtonFocus(),s.focused_part="channel_nav",this.hoverNav(s.channel_selection)):0<e&&this.clickLiveSettingsButton(s.live_settings_button_selection);break;case"channel_sidebar_sub":var n=this.getCurrentSidebarSubOptions();n&&0!==n.length&&(s.sidebar_sub_selection+=e,s.sidebar_sub_selection<0&&(s.sidebar_sub_selection=0),s.sidebar_sub_selection>=n.length&&(s.sidebar_sub_selection=n.length-1),this.hoverSidebarSubOptionItem(s.sidebar_sub_selection));break;case"full_screen":case"live_controls":
...
"all"!==s[o].category_id&&(t[i]+='        <div           class="setting-select-multi-option '+(s[o].is_hide?"":"checked")+'"          data-category-index="'+o+'"          onmouseenter="settings_page.hoverHideCategoriesOption('+a+', true)"          onclick="settings_page.handleMenuClick()"        >          '+s[o].category_name+"        </div>",a++)}var n=$("#hide-categories-settings .setting-select-multi-options");$(n[0]).html(t.live),$(n[1]).html(t.movies),$(n[2]).html(t.series),
...
/**********************
   * STATE
   **********************/
isActive:!1,currentLanguage:"english",isUpperCase:!1,searchText:"",focusedRow:0,focusedCol:0,prevFocusedKey:null,maxLength:20,queryElement:null,
/**********************
   * LANGUAGE CYCLE
   **********************/
...
/**********************
   * FIXED ROWS (numbers — language-independent)
   **********************/
...
/**********************
   * LIFECYCLE
   **********************/
init:function(e){this.isActive=!0,this.searchText="",this.focusedRow=0,this.focusedCol=0,this.prevFocusedKey=null,this.queryElement=e||null,this.render(),this.hoverKey(1+this.numbersLayout.length,0)},destroy:function(){this.isActive=!1,this.searchText="",this.prevFocusedKey=null,this.queryElement=null,$("#static-keyboard-wrapper").html("")},
/**********************
   * RENDERING
   **********************/
...
e+='<div class="sk-row sk-action-row" data-row="0">',e+='<div class="sk-key sk-action-key sk-space-key" data-row="0" data-col="0" data-action="space" onmouseenter="static_keyboard.hoverKey(0,0)" onclick="static_keyboard.pressKey()">SPACE</div>',e+='<div class="sk-key sk-action-key sk-delete-key" data-row="0" data-col="1" data-action="delete" onmouseenter="static_keyboard.hoverKey(0,1)" onclick="static_keyboard.pressKey()">'+s+"</div>",e+='<div class="sk-key sk-action-key sk-lang-key" id="sk-lang-btn" data-row="0" data-col="2" data-action="lang" onmouseenter="static_keyboard.hoverKey(0,2)" onclick="static_keyboard.pressKey()">'+t+"</div>",e+='<div class="sk-key sk-action-key sk-shift-key" id="sk-shift-btn" data-row="0" data-col="3" data-action="shift" onmouseenter="static_keyboard.hoverKey(0,3)" onclick="static_keyboard.pressKey()">'+i+"</div>",e+="</div>";
// Rows 1..numbersLayout.length: fixed number rows (language-independent)
for(var a=0;a<this.numbersLayout.length;a++){for(var o=1+a,n=(e+='<div class="sk-row" data-row="'+o+'">',this.numbersLayout[a]),r=0;r<n.length;r++)e+='<div class="sk-key" data-row="'+o+'" data-col="'+r+'" data-value="'+this.escapeAttr(n[r])+'" onmouseenter="static_keyboard.hoverKey('+o+","+r+')" onclick="static_keyboard.pressKey()">'+this.escapeHtml(n[r])+"</div>";e+="</div>"}
// Language letter rows (start after action row + number rows)
for(var l=this.getCurrentLayout(),c=1+this.numbersLayout.length,d=0;d<l.length;d++){for(var h=c+d,_=(e+='<div class="sk-row" data-row="'+h+'">',l[d]),u=0;u<_.length;u++)e+='<div class="sk-key" data-row="'+h+'" data-col="'+u+'" data-value="'+this.escapeAttr(_[u])+'" onmouseenter="static_keyboard.hoverKey('+h+","+u+')" onclick="static_keyboard.pressKey()">'+this.escapeHtml(_[u])+"</div>";e+="</div>"}$("#static-keyboard-wrapper").html(e)},updateKeys:function(){var e=this.focusedRow,t=this.focusedCol,i=this.getLastLetterRowIdx(),i=(i<e&&(e=i),this.getRowLength(e));i<=t&&(t=i-1),this.render(),this.prevFocusedKey=null,this.hoverKey(e,t)},
/**********************
   * FOCUS
   **********************/
hoverKey:function(e,t){var i,i;
// If focus is currently on a movie or suggestion, clear it
key_focused||("keyboard"!==search_page.keys.focused_part&&(search_page.keys.focused_part="keyboard",$(search_page.prev_dom).removeClass("active"),search_page.prev_dom=null),i='#static-keyboard-wrapper [data-row="'+e+'"][data-col="'+t+'"]',i=$(i),i.length&&($(this.prevFocusedKey).removeClass("active"),i.addClass("active"),this.prevFocusedKey=i[0],this.focusedRow=e,this.focusedCol=t,
// Scroll keyboard wrapper if needed
moveScrollPosition($("#static-keyboard-wrapper"),i,"vertical",!1)))},
/**********************
   * KEY PRESS
   **********************/
pressKey:function(){var e=this.focusedRow,t=this.focusedCol,e='#static-keyboard-wrapper [data-row="'+e+'"][data-col="'+t+'"]',t=$(e);if(t.length){var e=t.attr("data-action");if(e)switch(e){case"space":this.handleSpace();break;case"delete":this.handleDelete();break;case"lang":this.handleLangSwitch();break;case"shift":this.handleShift()}else{var e=t.attr("data-value");null!=e&&this.addCharacter(e)}}},addCharacter:function(e){this.searchText.length>=this.maxLength||(this.searchText+=e,this.updateQueryDisplay(),search_page.triggerStaticSearch())},handleSpace:function(){this.searchText.length>=this.maxLength||(this.searchText+=" ",this.updateQueryDisplay(),search_page.triggerStaticSearch())},handleDelete:function(){0!==this.searchText.length&&(this.searchText=this.searchText.slice(0,this.searchText.length-1),this.updateQueryDisplay(),search_page.triggerStaticSearch())},handleLangSwitch:function(){for(var e=this.languageOrder,t=-1,i=0;i<e.length;i++)if(e[i]===this.currentLanguage){t=i;break}t=(t+1)%e.length,this.currentLanguage=e[t],this.isUpperCase=!1,this.updateKeys()},handleShift:function(){this.isUpperCase=!this.isUpperCase,this.updateKeys()},
/**********************
   * QUERY DISPLAY
   **********************/
...
/**********************
   * NAVIGATION
   **********************/
navigateLeft:function(){0<this.focusedCol&&this.hoverKey(this.focusedRow,this.focusedCol-1)},navigateRight:function(){var e=this.getRowLength(this.focusedRow);this.focusedCol<e-1?this.hoverKey(this.focusedRow,this.focusedCol+1):search_page.focusFirstResultFromKeyboard()},navigateUp:function(){var e,t,i;0!==this.focusedRow&&(e=this.focusedRow-1,t=this.focusedCol,i=this.getRowLength(e),i<=t&&(t=i-1),this.hoverKey(e,t))},navigateDown:function(){var e=this.getLastLetterRowIdx(),e,t,i;this.focusedRow>=e?search_page.focusSuggestion(0):(e=this.focusedRow+1,t=this.focusedCol,i=this.getRowLength(e),i<=t&&(t=i-1),this.hoverKey(e,t))},
/**********************
   * HELPERS
   **********************/
getCurrentLayout:function(){var e=this.layouts[this.currentLanguage];return this.isUpperCase?e.uppercase:e.lowercase},getRowLength:function(e){var t,i,e;// action row: SPACE, DEL, LANG, SHIFT
return 0===e?4:(// rows 1..numbersEnd
t=this.numbersLayout.length,e<=t?this.numbersLayout[e-1].length:(i=this.getCurrentLayout(),e=e-(1+t),i[e]?i[e].length:0))},getLastLetterRowIdx:function(){return this.numbersLayout.length+this.getCurrentLayout().length},escapeAttr:function(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},escapeHtml:function(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}},search_page={keys:{top_menu_selection:0,hor_keys:[0,0,0],v_selection:0,movie_selection:[],focused_part:""},prev_dom:null,is_loading:!1,filtered_movies:[],render_counts:[0,0,0],prev_keyword:"",search_timeout:null,prev_route:"",top_menu_doms:$(".search-page-top-menu"),movie_doms:[],render_count_increment:50,searching_for:[],parent_elements:[$("#filtered_channels_container")[0],$("#filtered_movies_container")[0],$("#filtered_series_container")[0]],
...
r.filtered_movies.push([]),
// Add empty array for series
r.filtered_movies.push([]);break;default:r.filtered_movies.push(r.getFilteredMovies(a,t)),r.filtered_movies.push(r.getFilteredMovies(i,t)),r.filtered_movies.push(r.getFilteredMovies(s,t))}switch(r.render_counts=[0,0,0],r.keys.hor_keys=[0,0,0],r.movie_doms=[[],[],[]],$(r.parent_elements[0]).html(""),$(r.parent_elements[1]).html(""),$(r.parent_elements[2]).html(""),r.searching_for){case"vod":r.renderFilteredMovies(1,!1,!1);break;case"series":r.renderFilteredMovies(2,!1,!1);break;case"live":r.renderFilteredMovies(0,!1,!1);break;case"replay":r.renderFilteredMovies(0,!1,!1,!0);break;default:r.renderFilteredMovies(0,!1,!0),r.renderFilteredMovies(1,!1,!0),r.renderFilteredMovies(2,!1,!0)}r.prev_keyword=t;var e=2e3,n=r.filtered_movies[0].length+r.filtered_movies[1].length+r.filtered_movies[2].length;n<50&&(e=500),setTimeout(function(){showLoader(!1),r.is_loading=!1},e)}},400)},
// ── Static keyboard search (specific modes) ──────────────────────────────
triggerStaticSearch:function(){clearTimeout(this.search_timeout);var n=this;this.search_timeout=setTimeout(function(){var e=static_keyboard.getSearchText().toLowerCase();
// Clear results when query is too short
if(e.length<3)n.static_filtered_movies=[],n.render_counts=[0,0,0],n.keys.hor_keys=[0,0,0],n.movie_doms=[[],[],[]],$("#search-page-specific-results").html(""),$("#search-suggestions-list").html(""),n.suggestion_doms=[],n.prev_keyword="";else if(e!==n.prev_keyword){showLoader(!0),n.is_loading=!0;var t=VodModel.getCategories(!1,!1),i=SeriesModel.getCategories(!1,!1),s=LiveModel.getCategories(!1,!1),a=n.getReplayCategories();switch(n.filtered_movies=[],n.searching_for){case"vod":n.filtered_movies.push([]),n.filtered_movies.push(n.getFilteredMovies(t,e)),n.filtered_movies.push([]);break;case"series":n.filtered_movies.push([]),n.filtered_movies.push([]),n.filtered_movies.push(n.getFilteredMovies(i,e));break;case"live":n.filtered_movies.push(n.getFilteredMovies(s,e)),n.filtered_movies.push([]),n.filtered_movies.push([]);break;case"replay":n.filtered_movies.push(n.getFilteredMovies(a,e)),n.filtered_movies.push([]),n.filtered_movies.push([])}
// Determine active index for this mode
var o=0,o=("vod"===n.searching_for&&(o=1),"series"===n.searching_for&&(o=2),n.static_filtered_movies=n.filtered_movies[o],n.render_counts=[0,0,0],n.keys.hor_keys=[0,0,0],n.movie_doms=[[],[],[]],
// Render into the specific results container
n.renderStaticResults(o),n.renderSuggestions(),n.prev_keyword=e,n.static_filtered_movies.length<50?500:2e3);setTimeout(function(){showLoader(!1),n.is_loading=!1},o)}},400)},renderStaticResults:function(e){var t=this,i="replay"===this.searching_for,s=0===e?"channel":"vod",a=2===e?"cover":"stream_icon",o=2===e?"series_id":"stream_id",n,r=HOST+"app_src_min/images/default_movie.png",n=(0===e?(r=HOST+"app_src_min/images/logo.png",LiveModel):1===e?VodModel:SeriesModel).favourite_ids,l=this.filtered_movies[e],c=this.render_counts[e],d="";if(l&&0!==l.length){if(!(c>=l.length)){for(var h=l.slice(c,c+this.render_count_increment),_=0;_<h.length;_++){var u=h[_],m=n.includes(u[o]);d+='<div class="filtered-movie-container '+s+'"><div class="filtered-movie-wrapper" onmouseenter="search_page.hoverMovie('+(c+_)+","+e+')" onclick="search_page.handleMenuClick()">'+(m?'<div class="favourite-badge">'+svg_icons.getIcon("star","w-full h-full")+"</div>":"")+'<div class="filtered-movie-img-wrapper"><img src="'+u[a]+'" onerror="this.src=\''+r+'\'"></div><div class="filtered-movie-title-wrapper"><div class="filtered-movie-title">'+u.name+"</div></div></div></div>"}this.render_counts[e]+=h.length,0===c?$("#search-page-specific-results").html(d):(showLoader(!0),this.is_loading=!0,$("#search-page-specific-results").append(d),setTimeout(function(){showLoader(!1),t.is_loading=!1},500)),this.movie_doms[e]=$("#search-page-specific-results").find(".filtered-movie-wrapper")}}else 0===c&&($("#search-page-specific-results").html("<p class='search-no-results'>No results found!</p>"),this.movie_doms[e]=[])},renderSuggestions:function(){for(var e=this.static_filtered_movies,t="",i=Math.min(e.length,25),s=0;s<i;s++)t+='<div class="sk-suggestion-item" onmouseenter="search_page.hoverSuggestion('+s+')" onclick="search_page.selectSuggestion('+s+')">'+e[s].name+"</div>";$("#search-suggestions-list").html(t),this.suggestion_doms=$("#search-suggestions-list").find(".sk-suggestion-item")},focusSuggestion:function(e){this.suggestion_doms&&0!==this.suggestion_doms.length?(e<0&&(e=0),e>=this.suggestion_doms.length&&(e=this.suggestion_doms.length-1),this.keys.focused_part="suggestion_selection",this.suggestion_selection=e,static_keyboard.isActive&&static_keyboard.clearFocus(),$(this.prev_dom).removeClass("active"),$(this.suggestion_doms[e]).addClass("active"),this.prev_dom=this.suggestion_doms[e],moveScrollPosition($("#search-suggestions-list"),$(this.suggestion_doms[e]),"vertical",!1)):(
...
switch(this.searching_for){case"replay":case"live":o=0;break;case"vod":o=1;break;case"series":o=2}"live"==this.searching_for||"replay"==this.searching_for?t.hor_keys[o]+=3*e:t.hor_keys[o]+=4*e;var n=this.filtered_movies[o];
// If navigating upward (increment < 0) and:
// - Already at the top row or no valid row is found (ver_selection === -1)
(t.hor_keys[o]>=n.length&&(t.hor_keys[o]=n.length-1),t.hor_keys[o]<0)?t.hor_keys[o]=0:(
// If a valid row is found
-1!==o&&
// Update the hover to the new row and horizontal position
