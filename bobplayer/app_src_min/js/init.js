...
<div class="loader-image-container">\n\
  ...
  <p class="loading__loader-description" data-word_code="loading_message">Welcome to BOBPlayer! Enjoy seamless streaming of your favorite content, proudly powered by IBODev Solutions. We\'re here to bring entertainment to your fingertips with a professional and user-friendly experience.</p>\n\
...
<div id="login-container" class="height-100 hide">\n\
  <div class="login-left-part">\n\
    ...
    <div class="login-left-bottom">\n\
      ...
      <div class="login-left-apps-container">\n\
        <span class="login-left-available-on">Made By:</span>\n\
        <div class="login-left-apps">\n\
          <img src="'+HOST+'app_src_min/images/ibo-dev.png" alt="IBODEV" />\n\
        </div>\n\
      </div>\n\
    </div>\n\
  </div>\n\
...
<div id="home-search-refresh-container">\n\
  ...
  <div\n\
    ...
    onclick="home_page.handleMenuClick()"\n\
  >\n\
    <svg style="width: 2rem; height: 2rem;" width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">\n\
      <path d="M12.8649 5.04364C12.8649 7.45441 10.9106 9.40872 8.49985 9.40872C6.08908 9.40872 4.13477 7.45441 4.13477 5.04364C4.13477 2.63287 6.08908 0.678558 8.49985 0.678558C10.9106 0.678558 12.8649 2.63287 12.8649 5.04364Z" stroke="white" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>\n\
      <path d="M8.50022 12.6825C4.28138 12.6825 0.861328 16.1026 0.861328 20.3214H16.1391C16.1391 16.1026 12.7191 12.6825 8.50022 12.6825Z" stroke="white" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>\n\
    </svg>\n\
  </div>\n\
</div>\n\
</div>\n\
  ...
  <div id="menu-wrapper">\n\
    ...
    >\n\
      <div class="menu-item">\n\
        ...
        <div class="menu-item-img-container">\n\
          <img src="'+HOST+'app_src_min/images/home-imgs/live.png" alt="" />\n\
        </div>\n\
      </div>\n\
    </div>\n\
    <div\n\
    ...
    >\n\
      <div class="menu-item">\n\
        ...
        <div class="menu-item-img-container">\n\
          <img src="'+HOST+'app_src_min/images/home-imgs/movies.png" alt="" />\n\
        </div>\n\
      </div>\n\
    </div>\n\
    <div\n\
    ...
    >\n\
      <div class="menu-item">\n\
        ...
        <div class="menu-item-img-container">\n\
          <img src="'+HOST+'app_src_min/images/home-imgs/series.png" alt="" />\n\
        </div>\n\
      </div>\n\
    </div>\n\
    <div\n\
    ...
    >\n\
        <div class="menu-item">\n\
          ...
          <div class="menu-item-img-container">\n\
            <img src="'+HOST+'app_src_min/images/home-imgs/replay.png" alt="" />\n\
          </div>\n\
      </div>\n\
    </div>\n\
  </div>\n\
...
<div id="home-controls-container">\n\
  <div class="home-controls-wrapper">\n\
    <div id="home-top-controls">\n\
      <div id="home-top-stararcs" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(0)" onmouseenter="home_page.hoverControlsMenu(0)">\n\
        ...
        <div data-word_code="stararcs-proxy">Stararcs Proxy</div>\n\
      </div>\n\
      <div id="home-top-live-favorites" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(1)" onmouseenter="home_page.hoverControlsMenu(1)">\n\
        <div class="home-top-control-svg-wrapper">\n\
        ...
        <div data-word_code="live-favorites">Live Favorites</div>\n\
      </div>\n\
      <div id="home-top-channel-theme" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(2)" onmouseenter="home_page.hoverControlsMenu(2)">\n\
        <div class="home-top-control-svg-wrapper">\n\
      ...
      <div id="home-top-playlists" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(3)" onmouseenter="home_page.hoverControlsMenu(3)">\n\
        <div class="home-top-control-svg-wrapper">\n\
      ...
      <div id="home-top-settings" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(4)" onmouseenter="home_page.hoverControlsMenu(4)">\n\
        <div class="home-top-control-svg-wrapper">\n\
...
<div class="home-info-container">\n\
  <div class="home-info-item">\n\
    <div class="home-info-item-title">Mac Address:</div>\n\
    <div class="home-info-item-value mac-address"></div>\n\
  </div>\n\
  <div class="home-info-item">\n\
    <div class="home-info-item-title">Device Key:</div>\n\
    <div class="home-info-item-value device-key"></div>\n\
  </div>\n\
  <div class="home-info-item">\n\
    <div class="home-info-item-title">App Expiration:</div>\n\
    <div class="home-info-item-value user-account-expire-date"></div>\n\
  </div>\n\
  <div class="home-info-item">\n\
    <div class="home-info-item-title">Playlist will expire in:</div>\n\
    <div class="home-info-item-value playlist-will-expire-in"></div>\n\
  </div>\n\
</div>\n\
...
<div id="channel-page" class="height-100 hide">\n\
  ...
  <div class="right-container " id="channel-page-right-part">\n\
    ...
    <div class="bottom-label-items-container">\n\
      <div class="bottom-label-item" onmouseenter="channel_page.hoverColorButton(0)" onclick="channel_page.handleMenuClick()">\n\
      ...
      <div class="bottom-label-item" onmouseenter="channel_page.hoverColorButton(1)" onclick="channel_page.handleMenuClick()">\n\
        <div class="bottom-label-icon bottom-item-blue"></div>\n\
        <div class="bottom-label-text" data-word_code="search">\n\
          Search\n\
        </div>\n\
      </div>\n\
      <div class="bottom-label-item" onmouseenter="channel_page.hoverColorButton(2)" onclick="channel_page.handleMenuClick()">\n\
        <div class="bottom-label-icon bottom-item-yellow"></div>\n\
        <div class="bottom-label-text" data-word_code="fav">Fav</div>\n\
      </div>\n\
      <div class="bottom-label-item" onmouseenter="channel_page.hoverColorButton(3)" onclick="channel_page.handleMenuClick()">\n\
