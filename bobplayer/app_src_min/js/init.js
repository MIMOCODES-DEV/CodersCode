...
<div id="home-controls-container">\n\
  <div class="home-controls-wrapper">\n\
    <div id="home-top-controls">\n\
      <div id="home-top-live-favorites" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(0)" onmouseenter="home_page.hoverControlsMenu(0)">\n\
      ...
      <div id="home-top-channel-theme" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(1)" onmouseenter="home_page.hoverControlsMenu(1)">\n\
        <div class="home-top-control-svg-wrapper">\n\
      ...
      <div id="home-top-playlists" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(2)" onmouseenter="home_page.hoverControlsMenu(2)">\n\
        <div class="home-top-control-svg-wrapper">\n\
      ...
      <div id="home-top-settings" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(3)" onmouseenter="home_page.hoverControlsMenu(3)">\n\
        <div class="home-top-control-svg-wrapper">\n\
...
<div id="settings-page">\n\
  <div class="settings-page-left-part">\n\
    <div class="settings-page-option" onclick="settings_page.handleMenuClick()" onmouseenter="settings_page.hoverSettingsItem(1)" data-word_code="change_language">Change Language</div>\n\
