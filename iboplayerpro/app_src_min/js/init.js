...
var app_environment = "production"; // production or development
...
<div class="loading_bottom-credits-container">\n\
  <span class="loading_bottom-credits">\n\
    <span data-word_code="made_by">Made by</span> <img src="' +
  HOST +
  'app_src_min/images/ibo-dev.png" />\n\
  </span>\n\
</div>\n\
...
<div id="login-container" class="height-100 hide">\n\
  <div class="login-left-part">\n\
    <div class="login-left-top">\n\
      <img src="' +
  HOST +
  'app_src_min/images/logo.png"></img>\n\
    ...
    <div class="right-part-bottom">\n\
      ...
      <div class="login-right-instructions-container">\n\
        <div class="login-right-instruction">\n\
          <img src="' +
  HOST +
  'app_src_min/images/icons/instruction1.png"></img>\n\
          <span>Visit <span class="url website-url"></span>.</span>\n\
        </div>\n\
        <div class="login-right-instruction">\n\
          <img src="' +
  HOST +
  'app_src_min/images/icons/instruction2.png"></img>\n\
          <span>Log in using your device\'s MAC Address and unique device key.</span>\n\
        </div>\n\
        <div class="login-right-instruction">\n\
          <img src="' +
  HOST +
  'app_src_min/images/icons/instruction3.png"></img>\n\
          <div>\n\
        ...
        <div id="last-login-instruction" class="login-right-instruction">\n\
          <img src="' +
  HOST +
  'app_src_min/images/icons/instruction4.png"></img>\n\
...
<div id="home-search-refresh-container">\n\
  ...
  <div\n\
    ...
    onclick="home_page.handleMenuClick()"\n\
  >\n\
    <svg style="width: 2.5rem; height: 2.5rem;" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">\n\
...
<div id="menu-container">\n\
  <div id="menu-wrapper">\n\
    ...
    >\n\
      <div class="menu-item-top-shine"></div>\n\
      <div class="menu-item">\n\
...
<div id="home-controls-container">\n\
  <div class="home-controls-wrapper">\n\
    <div id="home-top-controls">\n\
      <div id="home-top-channel-theme" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(2)" onmouseenter="home_page.hoverControlsMenu(0)">\n\
    ...
    <div id="home-top-playlists" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(2)" onmouseenter="home_page.hoverControlsMenu(1)">\n\
      <div class="home-top-control-svg-wrapper">\n\
    ...
    <div id="home-top-settings" class="home-top-control-wrapper" onclick="home_page.clickControlsMenu(0)" onmouseenter="home_page.hoverControlsMenu(2)">\n\
      <div class="home-top-control-svg-wrapper">\n\
...
<div class="home-expiry-days-container">\n\
  ...
  <div class="home-expiry-days-value playlist-will-expire-in">47 days</div>\n\
</div>\n\
<div class="home-device-info-container">\n\
  <div class="home-device-info-item">\n\
    <div class="home-device-info-item-title">Mac Address:</div>\n\
    <div class="home-device-info-item-value mac-address">00:00:00:00:00:00</div>\n\
  </div>\n\
  <div class="home-device-info-item">\n\
    <div class="home-device-info-item-title">Device Key:</div>\n\
    <div class="home-device-info-item-value device-key">000000</div>\n\
  </div>\n\
  <div class="home-device-info-item">\n\
    <div class="home-device-info-item-title">App Expiry Date:</div>\n\
    <div class="home-device-info-item-value user-account-expire-date">N/A</div>\n\
  </div>\n\
</div>\n\
  ...
  <div class="right-container " id="channel-page-right-part">\n\
    <div class="player-container">\n\
      ...
      <div class="video-error">\n\
        <img src="' +
  HOST +
  'app_src_min/images/def_image.jpg" />\n\
      </div>\n\
...
<div id="vod-series-page" class="height-100 hide">\n\
  <div class="vod-img-bg">\n\
    <img id="movie-image" onerror="this.src=\'' +
  HOST +
  'app_src_min/images/default_movie_bg.png\'" alt="Movie Poster" >\n\
...
>\n\
  <div class="playlists-page-background">\n\
    <div class="playlists-page-background-img-container"><img src="' +
  HOST +
  'app_src_min/images/movies-bg.png" class="playlists-page-background-img" /></div>\n\
  ...
  <div class="playlists-page-footer">IBOPlayer Pro is a general media player and it does not include any content, IBOPlayer Pro is not responsible for the content you use in the application.<br />Please follow <span class="website-url highlight"></span> to add or manage your playlists.</div>\n\
    ...
    <div class="modal-body p-20" style="padding: 1.25rem 1.25rem">\n\
      <div class="image-radio-group">\n\
        <label class="image-radio" onclick="home_page.handleModalSelection(0)"\n\
          ...
          <img src="' +
  HOST +
  'app_src_min/images/themes/classic.png" alt="classic">\n\
        ...
        <label class="image-radio" onclick="home_page.handleModalSelection(1)" \n\
          ...
          <img src="' +
  HOST +
  'app_src_min/images/themes/normal.png" alt="normal">\n\
          <div class="text-circle-wrapper">\n\
          <span class="radio-circle"></span>\n\
        ...
        <label class="image-radio" onclick="home_page.handleModalSelection(2)" \n\
          ...
          <img src="' +
  HOST +
  'app_src_min/images/themes/modern.png" alt="modern">\n\
          <div class="text-circle-wrapper">\n\
          <span class="radio-circle"></span>\n\
