...
void 0===eval("typeof "+name)&&eval(name+" = ''")}),"samsung"===platform&&""!==host_smasung_version?version=host_smasung_version:"lg"===platform&&""!==host_lg_version?version=host_lg_version:"vidaa"===platform&&""!==host_vidaa_version?version=host_vidaa_version:"zeasn"===platform&&""!==host_zeasn_version?version=host_zeasn_version:"titanos"===platform&&""!==host_titanos_version&&(version=host_titanos_version),{mac_address:mac_address,app_type:platform,version:version}),encrypted_data=encryptRequest(data);$.ajax({method:"post",url:url+"/playlist_list",data:{data:encrypted_data},timeout:15e3,success:function(e){that.tried_panel_indexes=[],that.is_loading=!1;e=decryptResponse(e);playlist_urls=e.urls,resolve(e.urls||[])},error:function(e){that.tried_panel_indexes.push(url_index),that.tried_panel_indexes.length<panel_urls.length?attemptFetch(retryCount+1):(that.is_loading=!1,reject("Failed to fetch playlist list after "+(retryCount+1)+" attempts"))}})}attemptFetch()}))},loadApp:function(e){var t=moment().format("Y-MM-DD"),i=($("#loading-page").addClass("hide"),1<e.urls.length&&"demo"===e.urls[0].id&&e.urls.splice(0,1),e.urls);i.map(function(e,t){var i,s,a,o,n;e.url.includes("playlist")&&(i=(s=e.url.match(/(.*?)\/playlist\/(.*?)\/(.*?)\/(.*?)(?:\/(.*?))?\/?$/))[1],a=s[3],o=s[4],n=s[5],e.username=s=s[2],e.password=a,e.playlist_type="xc",e.url=i,e.origin_type="xc",e.origin_url=i+"/get.php?username="+s+"&password="+a+"&type="+o+"&output="+n)}),
