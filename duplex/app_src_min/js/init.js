...
var HTML = '<div id="loading-page" class="height-100 text-center">\n\
      <div class="loader-image-container">\n\
        ...
        <h1 class="loading-title">\n\
          DuplexTV Player: Your Gateway to Seamless IPTV Streaming\n\
        </h1>\n\
        <p class="loading-description">\n\
          DuplexTV Player is a cutting-edge media player designed to elevate\n\
          ...
          entertainment with DuplexTV Player.\n\
        </p>\n\
      </div>\n\
