...
if(app_environment == "development"){
    ...
    var SCRIPTS=[
      "app_src_min/js/libs/crypto-js-4.1.1.min.js",
...
var HTML = '    <div id="loading-page" class="height-100 text-center">\n\
      <div class="loader-image-container">\n\
        ...
        <h1 class="loading-title">\n\
          4K Player: Your Gateway to Seamless IPTV Streaming\n\
        </h1>\n\
        <p class="loading-description">\n\
          4K Player is a cutting-edge media player designed to elevate\n\
      ...
      <div id="loading-issue-container">\n\
        ...
        <div id="not-registered-issue-container" class="loading-issue-item hide">\n\
          <div class="loading-issue-message-container">\n\
            <div class="loading-issue-text">\n\
              Your device mac address does not exist in our system.<br />\n\
              Please register your device to access your content,<br />\n\
              For assistance, contact us at: <span class="highlight">tv.register4k@gmail.com</span>\n\
            </div>\n\
            <div class="loading-issue-info-item">\n\
              <span class="loading-issue-info-item-label"\n\
                >Your Mac Address:</span\n\
              >\n\
              <span class="loading-issue-info-item-value mac-address"></span>\n\
            </div>\n\
          </div>\n\
          <div class="loading-issue-btn-container">\n\
            <div\n\
              class="btn not-registered-issue-btn loading-issue-btn"\n\
              onmouseenter="login_page.hoverNotRegisteredIssueBtn(0)"\n\
              onclick="login_page.reloadApp()"\n\
              data-word_code="reload"\n\
            >\n\
              Reload\n\
            ...
            <div\n\
              class="not-registered-issue-btn loading-issue-btn btn"\n\
              onmouseenter="login_page.hoverNotRegisteredIssueBtn(1)"\n\
              onclick="login_page.exit()"\n\
              data-word_code="exit"\n\
            >\n\
              Exit\n\
  ...
  'app_src_min/images/subtitles-preview-bg.png" class="subtitle-settings-preview-bg" />\n\
          ...
          <div class="setting-option-container" id="smart-proxy-settings">\n\
            ...
            <div class="setting-option-body">\n\
              <div id="proxy-not-active">\n\
                <div class="proxy-sub-instructions" data-word_code="proxy-not-available">This feature is not available for now. Please call the support for any information.</div>\n\
              </div>\n\
              <div id="proxy-active">\n\
      ...
      >\n\
        ...
        <div class="playlists-page-footer">4K Player is a general media player and it does not include any content, 4K Player is not responsible for the content you use in the application.<br />Please follow <span class="website-url highlight"></span> to add or manage your playlists.</div>\n\
