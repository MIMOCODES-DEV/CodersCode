...
// Stararcs proxy key handling moved to clearStararcsConnectionKeys() in common.js,
// invoked from login_operation.getPlayListDetail(). It runs after settings.initFromLocal()
// so it can also reset the in-memory settings on a cold start (the actual fix).
var platform = "";
    ...
    <div id="app" style="display: none">\n\
      ...
      <div id="settings-page">\n\
        <div class="settings-page-left-part">\n\
          ...
          <div class="settings-page-option" onclick="settings_page.handleMenuClick()" onmouseenter="settings_page.hoverSettingsItem(10)" data-word_code="load_on_demand">Load on Demand</div>\n\
          <div class="settings-page-option" onclick="settings_page.handleMenuClick()" onmouseenter="settings_page.hoverSettingsItem(11)" data-word_code="app_initialization">App Initialization</div>\n\
        </div>\n\
  ...
  'app_src_min/images/subtitles-preview-bg.png" class="subtitle-settings-preview-bg" />\n\
      ...
      >\n\
        ...
        <div class="playlists-page-btns-container">\n\
          ...
          <div class="playlists-page-btn" onmouseenter="playlist_page.hoverBottomMenu(3)" onclick="playlist_page.handleMenuClick()"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 189 151" fill="none"><g clip-path="url(#clip0_21_5034)"><path d="M24.3601 94.7C0.330059 91.86 -9.24994 59.73 11.0401 44.32C19.6401 37.79 25.6001 39.12 35.3101 39.14C53.3401 39.17 71.3801 39.05 89.4101 39.12L114.99 0.72L116.66 0L188.73 150.98H142.75C141.41 147.72 140.08 144.29 138.54 141.13C127.11 117.8 115.71 91.8 103.32 69.29C95.9501 55.91 81.0401 54.11 71.5001 66.35L52.8501 94.71H82.7001C95.3701 94.71 108.83 109.24 109.17 121.81C109.51 134.31 98.0101 150.98 84.7601 150.98H13.0401L50.7901 94.71C42.4301 93.99 32.5401 95.68 24.3701 94.71L24.3601 94.7Z" fill="white"/></g><defs><clipPath id="clip0_21_5034"><rect width="188.73" height="150.98" fill="white"/></clipPath></defs></svg> StarArcs</div>\n\
        </div>\n\
